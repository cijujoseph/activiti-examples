...
public class EmailUtils {
	...
	public void sendEmail(final String[] to, final String subject,
		...
		MimeMessagePreparator preparator = new MimeMessagePreparator() {
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				String fromNameVar = env.getProperty(DEFAULT_EMAIL_DISPLAY_NAME_PROPERTY_NAME, "Activiti");
	...
	public String evaluateTemplate(String templateName, Map<String, Object>templateVariables) throws Exception  {
		return FreeMarkerTemplateUtils.processTemplateIntoString(
				this.freeMarkerConfig.getTemplate(templateName,"UTF-8"),
				templateVariables);
		
//1.5 onwards we recommend defining templates in Activiti Identity Management Module and use the following
